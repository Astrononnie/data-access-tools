...
~/anaconda3/bin/python colorPostage.py --user koikem --outDir png3 ./coords.txt
~/anaconda2/bin/python colorPostage.python2.py --user koikem --outDir png2 ./coords.txt
