...
def main():
    ...
    parser.add_argument('--rerun', default='any', choices='any any s19a_wide s19a_dud'.split())
...
TOP_PAGE = 'https://hscdata.mtk.nao.ac.jp/das_quarry/dr3/'
API = 'https://hscdata.mtk.nao.ac.jp/das_quarry/dr3/cgi-bin/cutout'
...
def checkPassword(user, password):
    with tempfile.NamedTemporaryFile() as netrc:
        netrc.write('machine hscdata.mtk.nao.ac.jp login {} password {}'.format(user, password))
        netrc.flush()
